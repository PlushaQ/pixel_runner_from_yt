...
def display_score():
    ...
    score_surface = test_font.render(f'Score: {current_time // 1000}', False, '#404040')
...
def collisions(obstacle_list, player_rect):
    if obstacle_list:
...
# intro screen
welcome_text = test_font.render("Pixel Runner", False, 'Black')
...
instruction_text = test_font.render("Press SPACE to run!", False, 'Black')
instruction_text_rect = instruction_text.get_rect(center=(400, 350))

# timers
obstacle_timer = pygame.USEREVENT + 1
pygame.time.set_timer(obstacle_timer, 1400)
snail_animations_timer = pygame.USEREVENT + 2
pygame.time.set_timer(snail_animations_timer, 500)
fly_animations_timer = pygame.USEREVENT + 3
pygame.time.set_timer(fly_animations_timer, 200)
